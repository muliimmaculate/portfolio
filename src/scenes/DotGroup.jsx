...
const selectedStyles = 'relative bg-red-700 before:absolute before:w-6 before:h-6 before:rounded-full before:border-2 before:border-red-700 before:left-[-50%] before:top-[-50%]';
